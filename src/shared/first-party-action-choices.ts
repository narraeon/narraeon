 ...
 * starting point and can be copied, edited, exported, or deleted.
 */
export const firstPartyActionChoicesPresetFiles: Record<string, string> = {
...
<html><head><meta charset="utf-8"><title>下一步建议</title></head><body>
<main id="player-options-root" aria-label="下一步建议"></main>
</body></html>
`,
