  ...
  test("生产提示区分即时保存与检查点归并，Runtime 只说明重放机制", () => {
    const locales = [
      ...
      },
      {
        ...
        state: [
          "Other durable outcomes recoverable from those originals",
          "Before a checkpoint",
          "Information below the threshold for a separate document",
          "Save enough to preserve continuity and meaning",
          "complete this turn's required writes before final narrative",
          "do not create another turn-by-turn log",
        ],
